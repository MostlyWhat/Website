<script lang="ts">
	 ...
	 * Marketing Layout
	 * 
	 * Layout for public marketing pages (home, about, services, etc.)
	...
	// View Transitions API - skip for same-page navigation (hash links) and docs routes
	onNavigate((navigation) => {
		...
		// Skip view transitions entirely for docs routes to avoid jumping
		const isDocsRoute = currentPath.startsWith('/docs') && targetPath?.startsWith('/docs');
