...
This End User License Agreement ("Agreement") is a legal agreement between you ("User" or "You") and MostlyWhat Systems ("Company," "We," "Us," or "Our") for the use of our software products, applications, and related services ("Software").
...
- **Personal or Business Use**: Use the Software for personal or internal business purposes
- **Updates**: Receive and install updates to the Software when made available
...
- **Copyright**: The Software is protected by copyright laws and international treaties
...
- **Copy or Distribute**: Copy, distribute, or disclose any part of the Software to third parties
- **Reverse Engineer**: Reverse engineer, decompile, disassemble, or attempt to derive the source code
- **Modify**: Modify, adapt, translate, or create derivative works based on the Software
- **Remove Notices**: Remove, alter, or obscure any proprietary notices on the Software
- **Circumvent**: Circumvent, disable, or interfere with security features of the Software
...
- **Data Collection**: Collection of usage data, analytics, and diagnostic information
- **Data Processing**: Processing of data to improve the Software and our services
- **Data Storage**: Storage of your data on our servers or third-party cloud services
...
- **Release Updates**: Release updates, patches, or new versions of the Software at any time
- **Modify Features**: Add, modify, or remove features from the Software
- **Require Updates**: Require you to install updates to continue using the Software
- **Automatic Updates**: Automatically download and install updates when connected to the internet
...
- **Third-Party Licenses**: Such components are subject to their own license terms
...
- **FITNESS**: Fitness for a particular purpose
- **NON-INFRINGEMENT**: Non-infringement of third-party rights
- **ACCURACY**: Accuracy, reliability, or completeness of the Software
...
- **Indirect Damages**: MostlyWhat Systems shall not be liable for any indirect, incidental, special, consequential, or punitive damages
- **Data Loss**: We are not liable for any loss of data, revenue, or profits
- **Maximum Liability**: Our total liability shall not exceed the amount you paid for the Software in the 12 months preceding the claim
...
- **By You**: You may terminate by uninstalling and destroying all copies of the Software
- **By Us**: We may terminate immediately if you breach any term of this Agreement
- **Effect of Termination**: Upon termination, you must cease all use and destroy all copies
...
- **Website**: https://mostlywhat.systems/legal
