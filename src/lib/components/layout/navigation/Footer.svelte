...
<footer class="border-t border-border bg-background">
	...
	<div class="grid grid-cols-12 gap-px border-t border-border bg-border">
		...
		<a
			...
			class="group col-span-12 flex items-center justify-center gap-2 bg-background px-6 py-4 transition-colors hover:bg-card lg:col-span-3"
		>
			<span class="font-ui text-xs tracking-wider group-hover:text-primary">START A PROJECT</span>
			<ArrowUpRight class="h-4 w-4 text-muted-foreground group-hover:text-primary" />
		</a>
	</div>
</footer>
