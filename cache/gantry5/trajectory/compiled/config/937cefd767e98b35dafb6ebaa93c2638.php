...
return [
    ...
    'timestamp' => 1698997454,
    'checksum' => '748a0a558234ee48d54f10e89e3edd5b',
    'files' => [
        'user/data/gantry5/themes/trajectory/config/_error' => [
            'index' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/_error/index.yaml',
                'modified' => 1698997438
            ],
            'layout' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/_error/layout.yaml',
                'modified' => 1698997438
            ]
        ],
        'user/data/gantry5/themes/trajectory/config/default' => [
            'index' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/index.yaml',
                'modified' => 1698997003
            ],
            'layout' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/layout.yaml',
                'modified' => 1698997003
            ],
            'page/assets' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/page/assets.yaml',
                'modified' => 1698996252
            ],
            'page/body' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/page/body.yaml',
                'modified' => 1698996252
            ],
            'page/fontawesome' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/page/fontawesome.yaml',
                'modified' => 1698996252
            ],
            'page/head' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/page/head.yaml',
                'modified' => 1698996252
            ],
            'styles' => [
                'file' => 'user/data/gantry5/themes/trajectory/config/default/styles.yaml',
                'modified' => 1698981146
            ]
        ],
        'user/themes/trajectory/config/default' => [
            'page/body' => [
                'file' => 'user/themes/trajectory/config/default/page/body.yaml',
                'modified' => 1698886936
            ],
            'particles/branding' => [
                'file' => 'user/themes/trajectory/config/default/particles/branding.yaml',
                'modified' => 1698886651
            ],
            'particles/copyright' => [
                'file' => 'user/themes/trajectory/config/default/particles/copyright.yaml',
                'modified' => 1698888366
            ],
            'particles/logo' => [
                'file' => 'user/themes/trajectory/config/default/particles/logo.yaml',
                'modified' => 1698886651
            ],
            'particles/social' => [
                'file' => 'user/themes/trajectory/config/default/particles/social.yaml',
                'modified' => 1698650922
            ],
            'particles/totop' => [
                'file' => 'user/themes/trajectory/config/default/particles/totop.yaml',
                'modified' => 1698650922
            ]
        ]
    ],
    'data' => [
        'particles' => [
            ...
            'logo' => [
                ...
                'text' => '',
                'class' => 'g-logo g-logo-trajectory'
            ],
            'menu' => [
                'caching' => [
                    'type' => 'menu'
        ...
        'styles' => [
            ...
            'font' => [
                'family-default' => 'Metropolis, DM Sans, Arial, sans-serif',
                'family-title' => 'Metropolis, DM Sans, Arial, sans-serif',
                'family-mono' => 'DM Mono, Arial, sans-serif'
            ],
            'footer' => [
                'background' => '#000814',
                'text-color' => '#ffffff'
            ...
            'header' => [
                'background' => '#002357',
                'background-image' => 'gantry-media://header/moon.jpg',
        ...
        'page' => [
            ...
            'head' => [
                'meta' => [
                    0 => [
                        'og:site_name' => 'MostlyWhat Systems'
                    ],
                    1 => [
                        'og:description' => 'IDK TBD'
                    ]
                ],
                'head_bottom' => '',
                'atoms' => [
        ...
        'index' => [
            'name' => '_error',
            'timestamp' => 1698997438,
            'version' => 7,
            'preset' => [
                'image' => 'gantry-admin://images/layouts/default.png',
                'name' => '_error',
                'timestamp' => 1698650922
            ],
            'positions' => [
            ...
            'particles' => [
                ...
                'content' => [
                    'system-content-6051' => 'Page Content'
                ],
                'copyright' => [
